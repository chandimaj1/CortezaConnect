...
<div class="container-fluid" >
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <button class="btn btn-danger" id="fetch_dataset"><i class="fa fa-exclamation-triangle "></i> Reset &amp; Fetch Dataset</div>
        </div>
    </div>
    <hr>
...
<div class="modal" id="confirm_fetch">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 style="color:#c00">This will delete all data in airports table.</h4>
        You are about reset the airports table.<br>
        Table will be uploaded with records from the <b>airports.csv</b> in the plugin directory.
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" id="proceed_fetch_dataset">Proceed</button>
